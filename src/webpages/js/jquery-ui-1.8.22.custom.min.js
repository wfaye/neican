...
/*
 * ! jQuery UI - v1.8.22 - 2012-07-24 https://github.com/jquery/jquery-ui
...
(function(a, b) {
	...
	a.widget("ui.autocomplete", {
		...
		_create: function() {
			...
			this._initSource(),
			this.menu = a("<ul style='margin:0;padding:0;'></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo || "body", c)[0]).mousedown(function(c) {
