$(function(){
	var userName = getUrlParam("nickname");
	...
	function sendPhoneVerifyCode()
	{
		...
		if(!phone){
			...
			var veridata = {"nickname":user,"openid":openid,"access_token":token,"mobile":phone};
			$.ajax({
				url : "/ekb/auth/qq/register",
				type : "POST",
